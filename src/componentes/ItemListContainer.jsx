...
const productos= [
    ...
    {id:7 , nombre:"Kit Completo Pot", descripcion:"Flores Compactas+Fomenta el crecimiento+FErtilizante Biomineral+Produccion de Flores", precio:200, img:"" , categoria:"Otros", stock:25},
    {id:8 , nombre:"Nutri Pack Namaste", descripcion:"Raices Sanas y fuertes+Mejora Resinas, aromas y gustos+Tallos y ramas fuertes+Potenciador de Florestacion+Prevencion de plagas y hongos", precio:200, img:"" , categoria:"Otros", stock:23},
    {id:9 , nombre:"Macetas Mad Rocket", descripcion:"Guiadores de raices y ventanas para la autopoda radicular", precio:250, img:"" , categoria:"Otros", stock:7}
]
